...
export default function Experience() {
  ...
  return (
    <section
      id="experience"
      className="bg-gray-900 text-white py-16 md:py-24 relative overflow-hidden"
    >
      <ExperienceBackground />
      <div className="max-w-6xl mx-auto px-4 relative z-10">
        <h2 className="text-4xl font-bold mb-12 text-center text-blue-400 fade-in">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          {/* Work Experience */}
          <div>
            <h3 className="text-2xl font-bold mb-6 text-blue-300 fade-in-slow">
              Work Experience
            </h3>
            <div className="space-y-6">
              {experiences.map((exp, idx) => {
                const isCurrent =
                  exp.company === "Applied Electro Magnetics Pvt Ltd";
                return (
                  <div
                    key={idx}
                    className="experience-card bg-gray-800 p-6 rounded-lg border-l-4 border-blue-500 relative overflow-hidden"
                  ...
                  >
                    ...
                    {exp.projects && (
                      <div className="mb-4 rounded-lg border border-blue-500/30 bg-blue-950/20 p-4">
                        <h5 className="text-base font-semibold text-blue-200 mb-3">
                          Applied Electro Magnetics Projects
                        </h5>
            ...
            <div className="mt-8 bg-gray-800 p-6 rounded-lg border border-gray-700 hover:border-blue-500 transition duration-500">
              ...
              <ul className="space-y-3">
                <li className="flex items-center gap-2 text-gray-300 group">
                  ...
                  <span>
                    ADRDE Training Certificate — Radar-based Distance
                    Measurement & GPS Location Tracking | DRDO, 2022
                  </span>
                </li>
                <li className="flex items-center gap-2 text-gray-300 group">
                  <span className="text-cyan-400 text-xl">⬢</span>
                  <span>Programming with C/C++ | Internshala, 2022</span>
                </li>
                <li className="flex items-center gap-2 text-gray-300 group">
                  <span className="text-blue-400 text-xl">⬢</span>
                  <span>
                    Verilog HDL: VLSI Hardware Design Comprehensive | Udemy,
                    2023
                  </span>
                </li>
                <li className="flex items-center gap-2 text-gray-300 group">
                  <span className="text-purple-400 text-xl">⬢</span>
                  <span>Circuit Design Training Certification | SCUBE, 2023</span>
                </li>
              </ul>
            </div>
          </div>
